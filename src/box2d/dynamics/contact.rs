...
impl ContactEdge {
    ...
    pub fn contact(&self) -> Contact {
        unsafe { Contact::from_raw(self.contact) }
    }
...
impl Contact {
	pub unsafe fn from_raw(raw: *mut B2Contact) -> Self {
		Contact { raw: raw }
	}

	pub unsafe fn ptr(&self) -> *mut B2Contact {
		self.raw
	}
    ...
    pub fn get_next(&self) -> Contact {
        unsafe { Contact::from_raw(b2Contact_GetNext(self.ptr())) }
    }

    pub fn get_fixture_a(&self) -> Fixture {
        unsafe { Fixture::from_raw(b2Contact_GetFixtureA(self.ptr())) }
    }
    ...
    pub fn get_fixture_b(&self) -> Fixture {
        unsafe { Fixture::from_raw(b2Contact_GetFixtureB(self.ptr())) }
    }
